...
class HyperNewsTest(DjangoTest):
    ...
    def check_coming_soon_page(self) -> CheckResult:
        ...
        coming_soon_page_link = f'http://localhost:{self.port}/'

        try:
            page = self.read_page(f'http://localhost:{self.port}/')
        except urllib.error.URLError:
            return CheckResult.false(
                f'Cannot connect to the "Coming soon" page ({coming_soon_page_link}).')
        ...
        if (coming_soon_text not in page
            ...
            return CheckResult.false(
                f'"Coming soon" page ({coming_soon_page_link}) should contain "Coming soon" text'
            )
